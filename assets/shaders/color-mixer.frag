...
void main(){
    frag_color[0]= dot(vec3(red.x, red.y, red.z), fs_in.color);
    frag_color[1] = dot(vec3(green.x, green.y, green.z), fs_in.color);
    frag_color[2] = dot(vec3(blue.x, blue.y, blue.z), fs_in.color);
    frag_color[3] = 1.0;
}