...
namespace our {
    ...
    public:
        ...
        ~Mesh(){
            //TODO: (Req 2) Write this function
            // Deleting anything that is not needed anymore
