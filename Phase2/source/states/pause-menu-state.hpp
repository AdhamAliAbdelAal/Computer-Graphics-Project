...
class Pausestate: public our::State {
    ...
    void onInitialize() override {
        ...
        buttons[0].position = {300.0f, 300.0f};
        buttons[0].size = {600.0f, 55.0f};
        buttons[0].action = [this](){this->getApp()->changeState("play");};

        buttons[1].position = {350.0f, 390.0f};
        buttons[1].size = {500.0f, 55.0f};
